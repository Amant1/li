            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td><?php echo (date( "Y-m-d H:i:s",$vo["mtime"])); ?></td>
                        <td><?php echo ($vo["size"]); ?> KB</td>
                        <td>
                            <a href="/lichengmi/index.php/Admin/Maintain/doReduction/name/<?php echo ($vo["name"]); ?>" onclick="return shifou();"><button type="button" class="btn btn-w-m btn-info">还原</button></a>
                            <a href="/lichengmi/index.php/Admin/Maintain/delData/name/<?php echo ($vo["name"]); ?>" onclick="return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
                    ...
                    <div class="ibox-content">
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="/lichengmi/index.php/Admin/Maintain/doBackups" enctype="multipart/form-data">
                                <div class="form-group has-success">
                                    <center><h1>备份当前数据库</h1></center>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group has-success"><label class="col-sm-4 control-label">备注名称(不要写中文！)</label>

                                    <div class="col-sm-3"><input type="text" class="form-control" name="name" ></div>
                                </div>
                               <div class="ibox-content">
                            <div class="text-center">
                            <input type="submit" value="开始备份" class="btn btn-primary" data-toggle="modal">
                            </div>
...
<script>
    ...
    <!-- Data Tables -->
    <script src="/lichengmi/Public/Admin/js/plugins/dataTables/jquery.dataTables.js"></script>
    <script src="/lichengmi/Public/Admin/js/plugins/dataTables/dataTables.bootstrap.js"></script>
    <script src="/lichengmi/Public/Admin/js/plugins/dataTables/dataTables.responsive.js"></script>
    <script src="/lichengmi/Public/Admin/js/plugins/dataTables/dataTables.tableTools.min.js"></script>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                           <a href="/lichengmi/index.php/Admin/Gonggao/edit/id/<?php echo ($vo["id"]); ?>"><button type="button" class="btn btn-w-m btn-info">修改</button></a>
                            <a href="/lichengmi/index.php/Admin/Gonggao/delete/id/<?php echo ($vo["id"]); ?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>

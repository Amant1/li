            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                           <a href="/lichengmi/index.php/Admin/Fenlei/edit/id/<?php echo ($vo["id"]); ?>"><button type="button" class="btn btn-w-m btn-info">修改</button></a>
                            <a href="/lichengmi/index.php/Admin/Fenlei/delete/id/<?php echo ($vo["id"]); ?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
                    </tr>
                    <?php if(is_array($arr2)): foreach($arr2 as $k=>$vs): if($vo["id"] == $vs['fid']): ?><tr class="gradeU">
                        ...
                        <td>
                           <a href="/lichengmi/index.php/Admin/Fenlei/edit/id/<?php echo ($vs["id"]); ?>"><button type="button" class="btn btn-w-m btn-info">修改</button></a>
                            <a href="/lichengmi/index.php/Admin/Fenlei/delete/id/<?php echo ($vs["id"]); ?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>

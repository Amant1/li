            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td><?php if($vo["status"] == 1): ?><span class="label label-danger">禁用</span><?php else: ?><span class="label label-info">启用</span><?php endif; ?></td>
                        <td>
                           <a href="/lichengmi/index.php/Admin/User/xianshi/id/<?php echo ($vo["id"]); ?>" target="_blank"><button type="button" class="btn btn-w-m btn-warning">启用</button></a>
                            <a href="/lichengmi/index.php/Admin/User/reallydelete/id/<?php echo ($vo["id"]); ?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>

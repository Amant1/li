            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                            <a href="/lichengmi/index.php/Admin/Yaoqing/delete/id/<?php echo ($vo["id"]); ?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
                    </tr>
                    <?php if(is_array($arr2)): foreach($arr2 as $k=>$vs): if($vo["id"] == $vs['fid']): ?><tr class="gradeU">
                        ...
                        <td>
                           <a href="/lichengmi/index.php/Admin/Yaoqing/edit/id/<?php echo ($vs["id"]); ?>"><i class="fa fa-eyedropper"></i></a>
                           <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <a href="/lichengmi/index.php/Admin/Yaoqing/delete/id/<?php echo ($vs["id"]); ?>" onclick = "return shifou();"><i class="fa fa-times" style="color:red;"></i></a>
                        </td>

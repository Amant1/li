...
<head>
    ...
    <link href="/li/Public/Admin/css/bootstrap.min.css" rel="stylesheet">
    <link href="/li/Public/Admin/font-awesome/css/font-awesome.css" rel="stylesheet">

    <!-- Toastr style -->
    <link href="/li/Public/Admin/css/plugins/toastr/toastr.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="/li/Public/Admin/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">

    <link href="/li/Public/Admin/css/animate.css" rel="stylesheet">
    <link href="/li/Public/Admin/css/style.css" rel="stylesheet">
...
<script>
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/li/Public/Admin/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/li/Public/Admin/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/li/Public/Admin/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/li/Public/Admin/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/li/Public/Admin/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/li/Public/Admin/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <!-- Mainly scripts -->
    <script src="/li/Public/Admin/js/jquery-2.1.1.js"></script>
    <script src="/li/Public/Admin/js/bootstrap.min.js"></script>
    <script src="/li/Public/Admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/li/Public/Admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>

    <!-- Flot -->
    <script src="/li/Public/Admin/js/plugins/flot/jquery.flot.js"></script>
    <script src="/li/Public/Admin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/li/Public/Admin/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="/li/Public/Admin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/li/Public/Admin/js/plugins/flot/jquery.flot.pie.js"></script>

    <!-- Peity -->
    <script src="/li/Public/Admin/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="/li/Public/Admin/js/demo/peity-demo.js"></script>

    <!-- Custom and plugin javascript -->
    <script src="/li/Public/Admin/js/inspinia.js"></script>
    <script src="/li/Public/Admin/js/plugins/pace/pace.min.js"></script>

    <!-- jQuery UI -->
    <script src="/li/Public/Admin/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- GITTER -->
    <script src="/li/Public/Admin/js/plugins/gritter/jquery.gritter.min.js"></script>

    <!-- Sparkline -->
    <script src="/li/Public/Admin/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="/li/Public/Admin/js/demo/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="/li/Public/Admin/js/plugins/chartJs/Chart.min.js"></script>

    <!-- Toastr -->
    <script src="/li/Public/Admin/js/plugins/toastr/toastr.min.js"></script>
    ...
    <script>
        ...
        })(window,document,'script',' /li/Public/Admin/js/analytics.js','ga');

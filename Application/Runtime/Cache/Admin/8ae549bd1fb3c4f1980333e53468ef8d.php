                   ...
                   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="/lichengmi/index.php/Admin/Gonggao/doadd">
                                <div class="form-group has-success"><label class="col-sm-4 control-label">公告名称</label>

                                    <div class="col-sm-3"><input type="text" class="form-control" name="title" required></div>
                                </div>
                                     <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-4 control-label">公告内容</label>

                   ...
                   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="/lichengmi/index.php/Admin/Slides/doedit/id/<?php echo ($arr["id"]); ?>" enctype="multipart/form-data">
                                <div class="form-group has-success"><label class="col-sm-4 control-label">幻灯片名称</label>

                                    <div class="col-sm-3"><input type="text" class="form-control" name="title" required value = "<?php echo ($arr["title"]); ?>"></div>
                                </div>
                                <div class="form-group has-success"><label class="col-sm-4 control-label">幻灯片名称</label>

                                    <div class="col-sm-3"><input type="file" name="pic"></div>
                                </div>
                                     <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-4 control-label">幻灯片地址（前面请加上http://）</label>
                                    <div class="col-sm-3"><input type="text" class="form-control" name="url" required value = "<?php echo ($arr["url"]); ?>"></div>
                                    </div>
                                </div>
                               <div class="ibox-content">

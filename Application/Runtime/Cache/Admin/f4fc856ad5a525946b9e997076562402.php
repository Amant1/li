            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                           <a href="/lichengmi/index.php/Admin/Friendlink/update/id/<?php echo ($vo["id"]); ?>"><button type="button" class="btn btn-w-m btn-info">修改</button></a>
                            <a href="/lichengmi/index.php/Admin/Friendlink/delete/id/<?php echo ($vo["id"]); ?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>

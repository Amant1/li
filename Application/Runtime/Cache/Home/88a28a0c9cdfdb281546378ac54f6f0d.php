            ...
            <?php if($fenleiInfo["type"] == 1): ?><style>
                ...
                <div class="ibox">
                    <?php if(is_array($articleList)): foreach($articleList as $key=>$vo): ?><div class="ibox-content">
                                <div class="row">
                                    <div class="col-lg-2" >
                                       <a href="/li/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>" class="button_link">
                                        <img alt="image" class="img-responsive" src="/li/Public/Uploads/<?php echo ($vo["pic"]); ?>" style="min-height:120px;">
                                    ...
                                    <div class="col-lg-10">
                                        <a href="/li/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>" class="btn-link">
                                            <h2>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2" style="margin-top:10px;">
                                                <div class="small text-right">
                                                    <a href="/li/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>"><button type="button" class="btn btn-w-m btn-danger">查看全文</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <?php elseif($fenleiInfo["type"] == 2): ?>
                        <link rel="stylesheet" type="text/css" href="/li/Public/doudong/css/type2.css" />
                    <div class = "row">
                                ...
                                <div class="ibox float-e-margins">
                                    <div>
                                        ...
                                        <figure class="effect-layla">
                                            <img alt="image" class="img-responsive" src="/li/Public/Uploads/<?php echo ($vo["pic"]); ?>" style="width:100%;max-height:300px;">
                                            <figcaption>
                                            <h2><?php echo (msubstr(strip_tags($vo["title"]),0,20,'utf-8',false)); ?></h2>
                                            <p><?php echo (msubstr(strip_tags($vo["content"]),0,20,'utf-8',true)); ?></p>
                                            <a href="/li/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>">View more</a>
                                        </figcaption>
                                        </figure>
                                        </div>
                                        ...
                                        <div class="ibox-content profile-content" style="padding:10px;">
                                            <a href="/li/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>"><center><h2><strong><?php echo ($vo["title"]); ?></strong></h2></center></a>
                                            ...
                                            <div class="user-button">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <a href="/li/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>"><button type="button" class="btn btn-danger btn-sm btn-block"><i class="fa fa-envelope"></i>点击阅读</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="ibox">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <figure class="effect-goliath">
                                            <a href="/li/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>"><img alt="member" src="/li/Public/Uploads/<?php echo ($vo["pic"]); ?>" width="100%"></a>
                    ...
                    <a href="/li/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>">View more</a>
                                        ...
                                        <p>
                                            <?php echo (htmlspecialchars_decode(msubstr(strip_tags($vo["content"]),0,70,'utf-8',true))); ?>
                                        </p>
                                        <div>
                                            <span>个人对电影的评分:</span>
                        ...
                        <?php elseif($fenleiInfo["type"] == 4): ?>
                            <link rel="stylesheet" type="text/css" href="/li/Public/doudong/css/tilteffect.css" />
                            <link rel="stylesheet" type="text/css" href="/li/Public/doudong/css/demo.css" />
                        ...
                        <div class="grid__img grid__img--border">
                            <img src="/li/Public/Uploads/<?php echo ($vo["pic"]); ?>" class="tilt-effect" data-tilt-options='{ "bgfixed" : false, "movement": { "perspective" : 1000, "translateX" : 30, "translateY" : 30, "translateZ" : -50, "rotateX" : 3, "rotateY" : 3, "rotateZ" : 10 } }' alt="grid01"  width="100%;" />
                        </div>
                    </li>
                    </ul>
                                            </div>
                            ...
                            <script src="/li/Public/doudong/js/tiltfx.js"></script><?php endif; ?>
                    </div>

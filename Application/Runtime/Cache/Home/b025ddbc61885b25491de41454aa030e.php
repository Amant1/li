            ...
            <div class="wrapper wrapper-content">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="col-lg-9 fadeInRight">
                        ...
                        <div class="mail-box">
                            <div class="mail-body">
                                <form class="form-horizontal" action="/lichengmi/index.php/Home/User/doUpdateArticle/id/<?php echo ($arr["id"]); ?>" method="post" enctype= "multipart/form-data">
                                    ...
                                    <div class="form-group" style="display:none;" id = "biaoqian"><label class="col-sm-2 control-label">电影标签：</label>
                                        ...
                                        <div class="col-sm-10"><input type="text" class="form-control" name = "biaoqian" require value="<?php echo ($arr["biaoqian"]); ?>"></div>
                                    </div>

                                    <div class="form-group" style="display:none;" id = "pingfen"><label class="col-sm-2 control-label">评分0-100：</label>

                                        <div class="col-sm-10"><input type="text" class="form-control" name = "pingfen" require value="<?php echo ($arr["pingfen"]); ?>"></div>
                                    </div>

...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="/li/index.php/Home/Fenlei/index/id/<?php echo ($fenleiInfo["id"]); ?>"><?php echo ($fenleiInfo["name"]); ?></a>
            </li>
            <li class="active">
                    ...
                    <div class="ibox-content">
                        <div class="text-center article-title" style="margin:20px 0px 20px">
                            ...
                            <div style="margin-bottom:50px;">
                                <?php switch($fenleiInfo["type"]): case "1": ?><img src="/li/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>" alt="" style="width:100%"><?php break;?>
                                    <?php case "2": ?><!-- 音乐 -->
                                        <link rel="stylesheet" href="/li/Public/music/css/lanrenzhijia.css" type="text/css" />
                            ...
                            <script src="/li/Public/music/js/jquery.min.js"></script>
                            <script src='/li/Public/music/js/jquery.jplayer.min.js'></script>
                            <script src='/li/Public/music/js/jplayer.playlist.min.js'></script>
                            <script>
                                $(document).ready(function(){
                                  ...
                                  var playlist = [{
                                      ...
                                      mp3:"/li/Public/Uploads/<?php echo ($articleInfo["mp3"]); ?>",
                                          //oga:"http://www.jplayer.org/audio/ogg/Miaow-02-Hidden.ogg",
                                          poster: "/li/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>"
                                      }];
...
<!-- 音乐 --><?php break;?>
<?php case "3": ?><img src="/li/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>" alt="" style="width:100%"><?php break;?>
<?php default: ?>
<img src="/li/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>" alt="" style="width:100%"><?php endswitch;?>
    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form action="/li/index.php/Home/Article/replay/id/<?php echo ($articleInfo["id"]); ?>" method="post">
...
<div class="col-lg-3">
    <div class="widget-head-color-box navy-bg p-lg text-center" style="margin-top:0px;">
        ...
        <img src="/li/Public/Uploads/<?php echo ($userInfo["pic"]); ?>" class="img-circle circle-border m-b-md" alt="profile" height="150px;">
    </div>
    ...
    <div class="widget lazur-bg p-xl">
     ...
     <a href="/li/index.php/Home/Blog/index/id/<?php echo ($userInfo["id"]); ?>" target="_blank"><center><button type="button" class="btn btn-w-m btn-danger">查看他的主页</button></center></a>
 </div>
 <div class="widget yellow-bg p-lg text-left" style="padding-left:5px;padding-right:5px;">
    ...
    <ul class="todo-list m-t ui-sortable" style="color:#000;">
        <?php if(is_array($zuixin)): foreach($zuixin as $key=>$vo): ?><li>
                <span class="m-l-xs"><a href="/li/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>"><?php echo (msubstr($vo["title"],0,10,'utf-8',true)); ?></a></span>
            </li><?php endforeach; endif; ?>
    </ul>
</div>
...
<script>
    ...
    function replay(){
        $.ajax({
         type: "POST",
         url: "/li/index.php/Home/Article/getReplay",
         data: "id="+id+"&num="+num,
         success: function(msg){
           if(msg == 5){
            ...
            for (var i in msg)
            {
                ...
                if(msg[i].pic ==null){
                    var pic = '/li/Public/Uploads/default.png';
                }else{
                    var pic = "/li/Public/Uploads/"+msg[i].pic;
                }
                if(msg[i].uid == userid){
...
<?php if($fenleiInfo["type"] == 4): ?><link href="/li/Public/wenzixiaoguo/css/animate.css" rel="stylesheet">
    <script src="/li/Public/wenzixiaoguo/js/jquery.lettering.js"></script>
    <script src="/li/Public/wenzixiaoguo/js/jquery.textillate.js"></script>
    <script>
        $(function () {
            $('.text2').textillate({

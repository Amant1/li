...
<head>
    ...
    <title>我的文章-<?php echo ($SiteInfo["title"]); ?></title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <li>
                    <a href="/lichengmi/index.php/Home/Index/yaoqingma"><i class="fa fa-globe"></i> <span class="nav-label" style = "color:#ED5565;">邀请码与友链</span></a>
                </li>
                    </ul>
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php if(is_array($articleList)): foreach($articleList as $k=>$vo): ?><tr>
                                    ...
                                    <td><a href="/lichengmi/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>"><button type="button" class="btn btn-primary btn-xs">查看</button></a>
                                       <a href="/lichengmi/index.php/Home/User/updateArticle/id/<?php echo ($vo["id"]); ?>"><button type="button" class="btn btn-primary btn-xs">修改</button></a>
                                        <a href="/lichengmi/index.php/Home/User/delArticle/id/<?php echo ($vo["id"]); ?>" onclick="return queren()"><button type="button" class="btn btn-danger btn-xs">删除</button></a>
                                    </td>
...
<!-- 调用脚部文件 -->
        <div class="footer" style="z-index:9999;">
            <div class="pull-right">
               <a href="/lichengmi/index.php/Admin" target="_blank">后台登陆</a>&nbsp;&nbsp;<strong>如果你使用本站程序</strong> 请保留友情链接.
            </div>
            <div>

...
<html class=" js no-touch"><head>
    ...
    <!-- ==========================
    	Fonts
    =========================== -->
    <link href="/lichengmi/Public/blog/css_004.htm" rel="stylesheet" type="text/css">
    <link href="/lichengmi/Public/blog/css_002.htm" rel="stylesheet" type="text/css">
    <link href="/lichengmi/Public/blog/css_003.htm" rel="stylesheet" type="text/css">
    <link href="/lichengmi/Public/blog/css.htm" rel="stylesheet" type="text/css">


    <!-- ==========================
    	CSS
    =========================== -->
    <link href="/lichengmi/Public/blog/bootstrap.css" rel="stylesheet" type="text/css">
    <link href="/lichengmi/Public/blog/fonts/font-awesome.css" rel="stylesheet" type="text/css">
    <link href="/lichengmi/Public/blog/animate.css" rel="stylesheet" type="text/css">
    <link href="/lichengmi/Public/blog/creative-brands.css" rel="stylesheet" type="text/css">
    <link href="/lichengmi/Public/blog/vertical-carousel.css" rel="stylesheet" type="text/css">
    <link href="/lichengmi/Public/blog/custom.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
    ...
    <header>
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <img src="/lichengmi/Public/Uploads/<?php echo ($userPic); ?>" class="navbar-logo pull-left" alt="" style="border-radius: 50px;margin-top:7px;padding-top:0px;">
                    <a href="/lichengmi/index.php/Home/Blog/index/id/13" class="navbar-brand animated flipInX"><?php echo ($arr["truename"]); ?></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="myNavigation">
                    ...
                    <li><a href="http://www.lcm.wang/" class="scroll" target="_blank">回到里程密</a></li>
        ...
        <div class="jumbotron">
            <img src="/lichengmi/Public/Uploads/<?php echo ($userPic); ?>" class="img-responsive scrollpoint sp-effect3" alt="" style="border-radius: 370px;" width="370px;" height="370px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-2 hidden-xs scrollpoint sp-effect1"><!-- Profile image -->
                	<img src="/lichengmi/Public/Uploads/<?php echo ($userPic); ?>" class="image-bordered img-responsive" alt="" style="border-radius: 165px;">
                </div><!-- Profile end -->
    ...
    <section id="services" class="content-second">
        <div class="container">
            <div class="row">
                ...
                <img src="/lichengmi/Public/blog/ico5.png" alt="">
                ...
                <div class="col-md-3 service scrollpoint sp-effect1">
                <img src="/lichengmi/Public/blog/ico4.png" alt="">
                ...
                <img src="/lichengmi/Public/blog/ico1.png" alt="">
                <h3><?php echo ($info["shanchangtitle3"]); ?></h3>
                <p><?php echo ($info["shanchangcontent3"]); ?>.</p>
                </div>

                <div class="col-md-3 service scrollpoint sp-effect2">
                <img src="/lichengmi/Public/blog/ico3.png" alt="">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-8 col-md-8 col-md-offset-2 col-sm-offset-2 col-lg-offset-0 showcase-carousel hidden-xs scrollpoint sp-effect2">
                    <img src="/lichengmi/Public/blog/imac.png" class="img-responsive" alt="">

                    <div id="carousel-reference" class="carousel slide" data-ride="carousel">
                        <!-- Wrapper for slides -->
                        <div class="carousel-inner">
                            <div class="item active"><img src="/lichengmi/Public/blog/image_01.png" alt=""></div>
                            <div class="item"><img src="/lichengmi/Public/blog/image_02.png" alt=""></div>
                        </div>
   		...
   		<ul class="grid cs-style-4">
				<li>
					<figure class="scrollpoint sp-effect1">
						<div><img src="/lichengmi/Public/blog/ref1.png" alt="img04"></div>
						<figcaption>
							<h3>Lorem ipsum</h3>
							<a href="">Show me</a>
						</figcaption>
                ...
                <li>
					<figure class="scrollpoint sp-effect3">
						<div><img src="/lichengmi/Public/blog/ref2.png" alt="img04"></div>
						<figcaption>
							<h3>Lorem ipsum</h3>
							<a href="">Show me</a>
						</figcaption>
                ...
                <li>
					<figure class="scrollpoint sp-effect2">
						<div><img src="/lichengmi/Public/blog/ref3.png" alt="img04"></div>
						<figcaption>
							<h3>Lorem ipsum</h3>
							<a href="">Show me</a>
						</figcaption>
                ...
                <li>
					<figure class="scrollpoint sp-effect1">
						<div><img src="/lichengmi/Public/blog/ref4.png" alt="img04"></div>
						<figcaption>
							<h3>Lorem ipsum</h3>
							<a href="">Show me</a>
						</figcaption>
                ...
                <li>
					<figure class="scrollpoint sp-effect3">
						<div><img src="/lichengmi/Public/blog/ref5.png" alt="img04"></div>
						<figcaption>
							<h3>Lorem ipsum</h3>
							<a href="">Show me</a>
						</figcaption>
                ...
                <li>
					<figure class="scrollpoint sp-effect2">
						<div><img src="/lichengmi/Public/blog/ref6.png" alt="img04"></div>
						<figcaption>
							<h3>Lorem ipsum</h3>
							<a href="">Show me</a>
						</figcaption>
                ...
                <?php if(is_array($zuixinArticle)): foreach($zuixinArticle as $s=>$vo): ?><div class="col-sm-4 scrollpoint sp-effect<?php echo ($s+1); ?>">
                	<div class="blog-post">
                    	<div class="blog-body">
                        	...
                        	<a href="/lichengmi/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>" class="btn btn-primary">阅读更多</a>
                        </div>
                        <div class="blog-info">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 scrollpoint sp-effect1">
                    <div class="media">
                        <a class="pull-left" href="#"><img class="media-object img-circle" src="/lichengmi/Public/blog/tom.png" alt=""></a>
                        <div class="media-body">
                ...
                <div class="col-sm-6 scrollpoint sp-effect2">
                    <div class="media">
                        <a class="pull-left" href="#"><img class="media-object img-circle" src="/lichengmi/Public/blog/suzanne.png" alt=""></a>
                        <div class="media-body">
    ...
    <section id="contact" class="content-first">
        <div class="container">
            ...
            <!-- PRICING TABLE FIRST - start -->
                <div class="col-sm-12">
                	<img src="/lichengmi/Public/blog/macbook.png" class="img-responsive hidden-xs" alt="">
                    ...
                    <div class="macbook-inner black">
                    	<div class="row scrollpoint sp-effect4">
                        	<div class="col-sm-8">
                                ...
                                <form role="form" id="contactForm" action="/lichengmi/index.php/Home/Blog/send/id/<?php echo ($_GET['id']); ?>" method="post">
                            ...
                            <img src="/lichengmi/Public/Uploads/<?php echo ($userPic); ?>" class="contact-image image-responsive hidden-xs hidden-sm" alt="" >
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 scrollpoint sp-effect3">
                    ...
                    <p>© 这里是<?php echo ($arr["truename"]); ?>的主页，页面来自于： <a href="http://www.lcm.wang/" target="_blank" class="btn btn-footer">里程密</a></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- ==========================
    	JS
    =========================== -->
	<script src="/lichengmi/Public/blog/jquery-latest.js"></script>
	<script src="/lichengmi/Public/blog/bootstrap.js"></script>
    <script src="/lichengmi/Public/blog/jquery.htm"></script>
    <script src="/lichengmi/Public/blog/creative-brands.js"></script>
    <script src="/lichengmi/Public/blog/jquery.js"></script>
    <script src="/lichengmi/Public/blog/modernizr.js"></script>
    <script src="/lichengmi/Public/blog/waypoints.js"></script>
    <script src="/lichengmi/Public/blog/jquery_002.js"></script>
    <script src="/lichengmi/Public/blog/jqBootstrapValidation.js"></script>
    <script src="/lichengmi/Public/blog/custom.js"></script>
